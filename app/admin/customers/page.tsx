...
const INTEREST_TYPES = [
  ...
  'OUT_OF_STOCK_INTEREST', 'PRICING_REVIEW_INTEREST', 'SPA_WHOLESALE_INQUIRY',
] as const
    ...
    <main className="min-h-screen bg-black p-6 md:p-8">
      <div className="max-w-[1400px] mx-auto">
        <div className="flex items-center justify-between flex-wrap gap-3 mb-6">
          <div>
            <h1 className="font-heading text-2xl font-bold text-white">Customers &amp; Leads</h1>
            <p className="text-white/50 text-sm mt-0.5">{total} record{total === 1 ? '' : 's'}</p>
          </div>
