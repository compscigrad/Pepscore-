    ...
    <main className="min-h-screen bg-black p-8">
      <div className="max-w-[1000px] mx-auto">
        <div className="flex items-center justify-between flex-wrap gap-4 mb-8">
          <div>
            <h1 className="font-heading text-3xl font-bold text-white">Search Intelligence</h1>
            <p className="text-white/50 text-sm mt-1">First-party search demand, last {WINDOW_DAYS} days · Pepscore Lab</p>
          </div>
          <Link
            href="/admin"
